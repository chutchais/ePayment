...
class OrderResource(resources.ModelResource):
	class Meta:
		...
		skip_unchanged = True
		report_skipped= True
		fields =('bl__terminal','bl__name','name','ref','grand_total','payment_date','payment_ref','user__username',
...
class ContainerResource(resources.ModelResource):
	class Meta:
		...
		skip_unchanged = True
		report_skipped= True
		fields = ('container','order__name','cont_size','iso','lifton',
				'relocation','storage','total','invoice',
					'created','user')
		exclude = ('id')
...
class ContainerAdmin(ImportExportModelAdmin,ImportExportActionModelAdmin,admin.ModelAdmin):
	...
	list_filter = ['cont_size',ContainerDateFilter]
	list_display = ('container','order','cont_size','iso','lifton',
				'relocation','storage','total',
					'created','user')
	# list_editable = ('color','move_performa')
	# autocomplete_fields = ['parent']
	readonly_fields = ('created','updated','user')
